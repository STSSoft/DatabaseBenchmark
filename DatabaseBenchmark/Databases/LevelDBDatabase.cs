    ...
    public class LevelDBDatabase : Database
    {
        ...
        public override Dictionary<string, string> Settings
        {
            get
            {
                ...
                settings.Add("WriteBufferSize", WriteBufferSize.ToString());
                settings.Add("Cache", Cache.ToString());
                settings.Add("BlockSize", BlockSize.ToString());
                settings.Add("MaxOpenFiles", MaxOpenFiles.ToString());
                settings.Add("Compression", Compression.ToString());
